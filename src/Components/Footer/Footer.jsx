          ...
          <div className="grid md:grid-cols-4 md:gap-4 py-5 border-t-2 border-gray-300/10 text-black">
            ...
            <div className="py-8 px-4 space-y-6">
              <div className="text-2xl flex items-center gap-2 font-bold uppercase">
                <MdCompare className="text-secondary text-4xl" />
                <p className="">E-Tutor</p>
              </div>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Adipisci consectetur expedita modi temporibus repellat doloribus
                accusantium? exercitationem fugit.
              </p>
